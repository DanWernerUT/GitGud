...
class HiveText extends StatelessWidget {
  ...
  static Text   subHeader(String title, {Key? key, Color? color}) {return Text(title, key: key, style: TextStyle(fontFamily: 'Raleway-ExtraBold', fontSize: 24, fontWeight: FontWeight.w400, color: color ?? HiveColors.platinum),);}
  ...
  static Text     caption(String title, {Key? key, Color? color}) {return Text(title, key: key, style: TextStyle(fontFamily: 'Raleway-ExtraBold', fontSize: 14, fontWeight: FontWeight.w400, color: color ?? HiveColors.platinum,),);}
}